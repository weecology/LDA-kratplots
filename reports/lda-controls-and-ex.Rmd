...
```{r plot both LDA,echo = F, fig.height = 2, fig.width = 4}
...
## LDA models - separated 

#### Control plots LDA
```{r plot control LDA wt 1,echo = F, fig.height = 2, fig.width = 4}
# plot_lda_edited(selected_ctrl, time_data_ctrl$date)

ctrl_plots = plot_community_composition_gg(community_composition(selected_ctrl), c(1:selected_ctrl@k), ylim = c(0, 1))
...
#### Exclosures LDA
```{r plot excl LDA wt 1, echo = F, fig.height = 2, fig.width = 4}
