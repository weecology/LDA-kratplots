...
rodent_data = get_rodent_lda_data(time_or_plots = 'plots', treatment = 'control', type = 'granivores')
...
save(rodent_data, selected, changepoint, file = 'models/ctrl_plots_gran_1e4.Rdata')
